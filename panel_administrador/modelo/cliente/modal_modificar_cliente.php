 ...
 while($row = mysqli_fetch_array($query))
  {
      ...
      <input type='hidden' id='ID_cliente_edicion' value='<?php echo $ID_cliente; ?>'>
       ...
       <?php echo $direccion=$row['direccion']; ?> 
         <textarea rows="5" type='text' id='direccionClEd' class='form-control' onkeyup="validador_campo('direccion','resp_direccion',4)" maxlength='200' onkeypress='return valida_letras(event);' placeholder='(*)Escriba su direccion' onkeyup="validador_campo('direccion','resp_direccion',4)" maxlength='100' onkeypress='return valida_letras(event);'><?php echo $direccion;?></textarea>
