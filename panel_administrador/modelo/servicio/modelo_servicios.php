...
?>
			<div class="row">
                <div class="col-md-10 col-sm-12" style='color:yellow;'>
					<a href="#" class="btn btn-info" id="agregar_servicio"  onclick="abrirModalAgregarServicio()">Agregar Sercicio</a>Listado de todos los servicios registrados hasta la ultima fecha :<p>
                </div><!--/.col-md-3-->
	         </div>
							...
							<?php
								...
								$result = mysqli_query($conectador, "select * from servicio order by id_servicio desc;"); 
			                                ...
			                                <tbody style="background:#f9def9; padding:0px; margin:0px; color:black;">';
												...
												while($c<sizeof($infoTablasAdmin)){
													if($infoTablasAdmin[$c][0]>0){
														echo "<tr><td>".$infoTablasAdmin[$c][0]."</td><td>".$infoTablasAdmin[$c][1]."</td><td>".$infoTablasAdmin[$c][2]."</td><td>".$infoTablasAdmin[$c][3]."</td><td>".$infoTablasAdmin[$c][4]."</td><td>".$infoTablasAdmin[$c][5]."</td><td>".$infoTablasAdmin[$c][6]."</td><td>".$infoTablasAdmin[$c][7]."</td><td>".$infoTablasAdmin[$c][8]."</td><td>".$infoTablasAdmin[$c][9]."</td><td>".$infoTablasAdmin[$c][10]."</td>";
