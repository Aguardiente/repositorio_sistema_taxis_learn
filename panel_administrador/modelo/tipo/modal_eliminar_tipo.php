...
<!-- Modal eliminar tipo -->
        ...
        echo '
<div class="modal fade" id="ModalEliminarTipo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <h5 class="modal-title" style="color:white; text-shadow:1px 1px 1px #585858;">Eliminarás al tipo ¿Estas seguro?</h5>
       </div>
      ...
      <div class="modal-footer justify-content-center" tyle="background: ; padding:10px; margin:0px; color:black;">
        <a type="button" onclick="eliminarTipo('.$_POST['idTpElim'].')" class="btn btn-default btn-md" style="border-radius: 20px;">Aceptar
