<?php
  ...
  $sql=mysqli_query($conectador,"INSERT INTO `Factura` (`ID_Factura`,`servicio` ,`chofer` ,`cliente` ,`descripcion` ,`tipo` ,`total` ,`pago` ,`saldo` ,`nit_cliente` ,`fecha_emision`, `hora` ) VALUES (NULL, '$servicio' , '$chofer' , '$cliente' , '$descripcion' , '$tipo' , '$total' , '$pago' , '$saldo' , '$nit_cliente' , '".date('y/m/d')."' , '".date('g:ia')."' )"); 
